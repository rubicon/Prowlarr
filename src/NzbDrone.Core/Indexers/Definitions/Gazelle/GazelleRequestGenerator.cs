...
namespace NzbDrone.Core.Indexers.Gazelle
{
    public class GazelleRequestGenerator : IIndexerRequestGenerator
    {
        ...
        protected virtual string DownloadUrl => Settings.BaseUrl + "torrents.php?action=download&usetoken=" + (Settings.UseFreeleechToken ? "1" : "0") + "&id=";
        protected virtual string DetailsUrl => Settings.BaseUrl + "torrents.php?torrentid=";
